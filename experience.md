...
This page highlights my professional experience across IT support, cybersecurity education, information security, public sector IT, and soccer officiating.
...
<div class="experience-card">
  ...
  <ul>
    ...
    <li>Built a supportive learning community by providing guidance to help aspiring analysts bridge the gap between theory and practice.</li>
  </ul>
...
<div class="experience-card">
  ...
  <ul>
    ...
    <li>Developed three unique detection rules per technique across two SIEM platforms and one EDR solution to reduce blind spots in defensive coverage.</li>
...
<div class="experience-card">
  ...
  <ul>
    <li>Officiated competitive matches across youth, high school, college, and semi professional levels, making real time decisions under pressure while managing communication between players, coaches, and referee crews.</li>
    <li>Led pre match briefings and coordinated in game communication to maintain consistency, reduce confusion, and support accurate decision making.</li>
    <li>Refereed semi professional leagues such as USL League 2, USL League W, NPSL, WPSL, MWPL, and UPSL.</li>
  </ul>
</div>
...
<div class="experience-card">
  ...
  <ul>
    <li>Refereed Division II, Division III, NAIA, and JUCO college soccer leagues.</li>
    <li>Applied consistent judgment, positioning, communication, and game management across competitive college environments.</li>
    <li>Worked with referee crews to support accurate decisions, professional match control, and effective team communication.</li>
  </ul>
</div>
...
<div class="experience-card">
  ...
  <ul>
    <li>Refereed top youth leagues such as MLS NEXT, MLS NEXT 2, GA, ECNL, ECNL RL, EAL, NAL, Elite 64, MWC, NPL, DPL, ODP, Aspire, Missouri State Cup, and Missouri Presidents Cup.</li>
